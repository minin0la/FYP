...
class FridgeBud_V1_0:
    def __init__(self, top=None):
        ...
        self.milk_add_button = Button(top)
        self.milk_add_button.place(relx=0.14, rely=0.77, height=42, width=77)
        self.milk_add_button.configure(activebackground="#d9d9d9")
        self.milk_add_button.configure(activeforeground="#000000")
        self.milk_add_button.configure(background="#d9d9d9")
        self.milk_add_button.configure(foreground="#000000")
        self.milk_add_button.configure(highlightbackground="#d9d9d9")
        self.milk_add_button.configure(highlightcolor="black")
        self.milk_add_button.configure(text='''ADD''')
        self.milk_add_button.bind('<Button-1>',lambda e:GUI_support.milk_add_button(e))

        self.weather_button = Button(top)
        self.weather_button.place(relx=0.05, rely=0.6, height=42, width=177)
        ...
        self.information_box.place(relx=0.04, rely=0.03, height=254, width=471)
        ...
        self.storage_label.configure(activebackground="#f9f9f9")
        self.storage_label.configure(activeforeground="black")
        self.storage_label.configure(background="#d9d9d9")
        self.storage_label.configure(foreground="#000000")
        self.storage_label.configure(highlightbackground="#d9d9d9")
        self.storage_label.configure(highlightcolor="black")
        ...
        self.Scrolledlistbox1.place(relx=0.68, rely=0.18, relheight=0.75
                , relwidth=0.3)
        ...
        self.item_list_box.place(relx=0.69, rely=0.07, height=54, width=221)
        ...
        self.milk_remove_button = Button(top)
        self.milk_remove_button.place(relx=0.25, rely=0.77, height=42, width=77)
        self.milk_remove_button.configure(activebackground="#d9d9d9")
        self.milk_remove_button.configure(activeforeground="#000000")
        self.milk_remove_button.configure(background="#d9d9d9")
        self.milk_remove_button.configure(foreground="#000000")
        self.milk_remove_button.configure(highlightbackground="#d9d9d9")
        self.milk_remove_button.configure(highlightcolor="black")
        self.milk_remove_button.configure(relief=RAISED)
        self.milk_remove_button.configure(text='''REMOVE''')
        self.milk_remove_button.bind('<Button-1>',lambda e:GUI_support.milk_remove_button(e))

        self.milk_label = Label(top)
        self.milk_label.place(relx=0.05, rely=0.77, height=44, width=55)
        self.milk_label.configure(activebackground="#f9f9f9")
        self.milk_label.configure(activeforeground="black")
        self.milk_label.configure(background="#d9d9d9")
        self.milk_label.configure(font=font9)
        self.milk_label.configure(foreground="#000000")
        self.milk_label.configure(highlightbackground="#d9d9d9")
        self.milk_label.configure(highlightcolor="black")
        self.milk_label.configure(text='''Milk''')
        ...
        self.refresh_button = Button(top)
        self.refresh_button.place(relx=0.79, rely=0.95, height=22, width=57)
        self.refresh_button.configure(activebackground="#d9d9d9")
        ...
        self.refresh_button.configure(width=57)
