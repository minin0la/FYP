...
class FridgeBud:
    def __init__(self, top=None):
        ...
        img = PIL.Image.open("Images/Milk.gif")
        ...
        img = PIL.Image.open("Images/Cans.gif")
        img = img.resize((152, 177), PIL.Image.ANTIALIAS)
        ...
        img = PIL.Image.open("Images/Meat_Abstract.gif")
        img = img.resize((152, 177), PIL.Image.ANTIALIAS)
        ...
        img = PIL.Image.open("Images/Fish.gif")
        img = img.resize((152, 177), PIL.Image.ANTIALIAS)
        ...
        img = PIL.Image.open("Images/veg.gif")
        img = img.resize((152, 177), PIL.Image.ANTIALIAS)
        ...
        img = PIL.Image.open("Images/Fruits.gif")
        img = img.resize((152, 177), PIL.Image.ANTIALIAS)
